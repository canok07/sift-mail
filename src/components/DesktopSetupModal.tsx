        ...
        <div className="p-4 sm:p-6 overflow-y-auto space-y-5">
          ...
          <div className={`p-4 rounded-xl border ${cardBg} space-y-2.5`}>
            ...
            <p className="text-xs opacity-75">
              İsterseniz projedeki <code className="px-1.5 py-0.5 rounded text-[11px] font-mono bg-black/5 dark:bg-white/10">electron/main.cjs</code> dosyasını kullanarak kendi NSIS veya AppImage paketinizi doğrudan oluşturabilirsiniz.
            </p>
