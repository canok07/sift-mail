...
(async()=>{
 ...
 const child=fork(path.join(dist,'server.cjs'),[],{execPath:path.join(app,'Sift.exe'),cwd:data,env:{...process.env,ELECTRON_RUN_AS_NODE:'1',NODE_ENV:'production',HOST:'127.0.0.1',PORT:'47836',SIFT_DATA_DIR:data,SIFT_DIST_PATH:dist},stdio:['ignore','ignore','pipe','ipc']});
 try {
