 ...
 * Uses the short-lived in-memory token returned by the local backend handshake.
 * Secrets are deliberately never read from localStorage or renderer build variables.
 */
