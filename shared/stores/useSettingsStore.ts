...
export interface SettingsState {
  ...
  setAllowCloudEmailBody: (enabled: boolean) => void;
...
export const useSettingsStore = create<SettingsState>()(
  persist(
    (set) => ({
      ...
      setAllowCloudEmailBody: (allowCloudEmailBody) => set({ allowCloudEmailBody }),
    ...
    }),
    {
      ...
      partialize: (state) => ({
        theme: state.theme, language: state.language, blockTrackers: state.blockTrackers,
        requireBiometric: state.requireBiometric, autoDeleteUnsubscribed: state.autoDeleteUnsubscribed,
        aiProvider: state.aiProvider, aiEnabled: state.aiEnabled, allowCloudEmailBody: state.allowCloudEmailBody, ollamaEndpoint: state.ollamaEndpoint,
        telegramEnabled: state.telegramEnabled, accentColor: state.accentColor,
        backgroundImage: state.backgroundImage, fontFamily: state.fontFamily,
        fontSize: state.fontSize, pageSize: state.pageSize,
      }),
    }
  )
);
